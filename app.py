...
st.set_page_config(
    page_title="Clinical EHR 30-Day Mortality & ICU Risk Stratification Engine",
    page_icon="🤖",
    layout="wide"
)

st.title("🎯 Clinical EHR 30-Day Mortality & ICU Risk Stratification Engine")
st.markdown("**Domain**: `Healthcare / Clinical Machine Learning` | **Tech Stack**: `LightGBM, Scikit-Learn, Streamlit`")
